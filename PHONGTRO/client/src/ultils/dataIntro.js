export const text = {
    title: 'Tại sao lại chọn Ngoinhavuive.com?',
    description: 'Chúng tôi biết bạn có rất nhiều lựa chọn, nhưng Ngoinhavuive tự hào là trang web đứng top google về các từ khóa: ',
